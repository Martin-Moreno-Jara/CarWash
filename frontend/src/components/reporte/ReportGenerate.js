...
const ReporteGenerate = () => {    
    ...
    const [empcalificacionservicios, setEmpCalificacionServicios] = useState(false);
        ...
        <div className="main-container-report">
            ...
            <form className="form-div-report"  onSubmit={handleSubmit}>
                ...
                <div>
                        ...
                        <input type="date" className="form-control" value={fechainicio} onChange={handleFechaInicio} />
                    </div>
                    <div>
                        <label>Fecha de fin:</label>
                        <input type="date" className="form-control" value={fechafin} onChange={handleFechaFin} />
                    </div>
                <div>
                    <div
                    ...
                    {showServices && (
                        ...
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleServiciosTerminados}/>
                            <span className="checkbox-custom"></span>
                            Cantidad de servicios terminados
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox " onChange={handleDineroRecaudado}/>
                            <span className="checkbox-custom"></span>
                            Dinero recuadado
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleServiciosPrestados}/>
                            <span className="checkbox-custom"></span>
                            Tipos de servicios prestados
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleProporcionTiposAutos}/>
                            <span className="checkbox-custom"></span>
                            Proporción de tipos de autos
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleCalificacionServicios}/>
                            <span className="checkbox-custom"></span>
                ...
                <div >
                    ...
                    {showEmployees && (
                        <div className="formatos-report">
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleEmpServiciosCompletados}/>
                            <span className="checkbox-custom"></span>
                            Servicios completados
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleEmpDineroRecaudado} />
                            <span className="checkbox-custom"></span>
                            Cantidad de dinero recuadada
                        </label>
                        <label className="checklist-item">
                            <input type="checkbox" className="checklist-checkbox" onChange={handleEmpCalificacionServicios}/>
                            <span className="checkbox-custom"></span>
                            Calificación de los servicios
                        </label>
                        </div>
